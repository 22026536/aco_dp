...
Điều chỉnh: Cả hệt số phạt và hệ số khuyến khích đều được tự điều chỉnh dựa trên Tổng chi phí, số lượng cặp nút, tổng trọng số, số lượng trọng số... điều này giúp hệ số phạt và hệ số khuyến khích sẽ phù hợp với từng bài toán
...
Chi phí cuối cùng: Chi phí thực + Độ vi phạm x Hệ số phạt (giống hệ số phạt bên trên)

Điều này giúp chọn ra kiến tốt ít vi phạm để đưa vào local search
